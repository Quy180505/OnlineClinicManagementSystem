    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
            throws Exception {
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/specialties").hasAnyRole("PATIENT", "STAFF", "DOCTOR", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/medical-services").hasAnyRole("PATIENT", "STAFF", "DOCTOR", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/doctor-schedules/future").hasRole("PATIENT")
                        .requestMatchers("/api/doctor-schedules/**").hasRole("STAFF")
                        .requestMatchers(HttpMethod.GET, "/api/appointment-statuses").hasAnyRole("PATIENT", "STAFF", "DOCTOR", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/medical-records/appointment/*").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/api/medical-records/my-history").hasRole("PATIENT")
                        .requestMatchers(HttpMethod.GET, "/api/medical-records/my-history/*").hasRole("PATIENT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/laboratory/medical-records/{medicalRecordId}/available-test-services").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET,"/api/laboratory/medical-records/{medicalRecordId}/test-orders").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET,"/api/laboratory/test-orders").hasRole("STAFF")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/laboratory/test-order-details/*/result").hasAnyRole("DOCTOR","STAFF")
                        .requestMatchers(HttpMethod.GET, "/api/laboratory/patient/results").hasRole("PATIENT")
                        .requestMatchers(HttpMethod.GET, "/api/laboratory/patient/results/*").hasRole("PATIENT")
