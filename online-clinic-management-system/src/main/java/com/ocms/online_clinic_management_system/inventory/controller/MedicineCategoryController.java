...
public class MedicineCategoryController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PageResponse<MedicineCategoryResponse>>> search(@ParameterObject Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(medicineCategoryService.search(pageable)));
    }
