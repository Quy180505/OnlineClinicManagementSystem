...
public interface MedicalServiceService {
    ...
    PageResponse<MedicalServiceResponse> getAll(String keyword, Long specialtyId, MedicalServiceType serviceType, int page, int size, String sortBy, String direction);
